...
print("Response after uploading to BDBA server: ", post_response_json, flush=True)
...
for i in range(iterations):
  ...
  print("Status of scan: ", get_response_json, flush=True)
  ...
  if i == iterations - 1:
    ...
    break
  print(f"Retrying status check {iterations}:", get_response_json, flush=True)
