...
pip_cmd_output1 = subprocess.run(pip_cmd1, capture_output=True, text=True)
print(pip_cmd_output1.stdout)
print(pip_cmd_output1.stderr)

pip_cmd2 = "pip install abi==3.0.0.dev50 --extra-index-url=https://ubit-artifactory-or.intel.com/artifactory/api/pypi/one-windows-pypi-local/simple --proxy=http://proxy-chain.intel.com:912 "
